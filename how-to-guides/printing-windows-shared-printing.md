...
**Printer name** - This is the name that the printer will show inside of The Order Guys.

**API Key** - This needs to be copied from the printer settings inside of The Order Guys.
